...
public:
    ...
    struct InstanceTrait {
        ...
        Interval<int> productNum = Interval<int>(2000, Problem::MaxProductNum);
    };
...
public:
    ...
    void convertSsppmpnInstance(const String &ssppmpnPath, int index);
    void convertSsppmpnInstances();
